Java.perform(function () {
        ...
        var Interceptor = Java.use("okhttp0.Interceptor");
        var MyInterceptor = Java.registerClass({
            name: "okhttp0.MyInterceptor",
        ...
        var OkHttpClient = Java.use("okhttp0.OkHttpClient");
        console.log(OkHttpClient);
        OkHttpClient.$init.overload('okhttp0.OkHttpClient$Builder').implementation = function (Builder) {
            console.log("OkHttpClient.$init:", this, Java.cast(Builder.interceptors(), ArrayList));
            this.$init(Builder);
        };
 
        var MyInterceptorObj = MyInterceptor.$new();
        var Builder = Java.use("okhttp0.OkHttpClient$Builder");
        console.log(Builder);
